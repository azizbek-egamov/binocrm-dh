...
import { AmBarChart, AmAreaChart, AmPieChart, AmLineChart, AmComposedChart } from '../../components/AmCharts';
...
import { OperatorFunnel, useThemeColors } from '../../components/OperatorFunnelChart';
    ...
    const fetchStats = async () => {
        ...
        try {
            ...
            if (activeTab === 'leads' && currentData?.leads_by_operator) {
                setOperators(currentData.leads_by_operator.map(o => o.operator_name).filter(Boolean));
            }
        } catch (error) {
        ...
        return (
            <div className="analytics-dashboard">
                <div className="charts-grid">
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">2. Shartnomalar holati bo'yicha</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">3. Vaqt o'tishi bilan umumiy daromad</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">4. Shaharlar bo'yicha daromad</span>
                    ...
                    <div className="chart-card wide">
                        <div className="chart-card-header">
                            <span className="chart-number">7. Binolar bo'yicha sotilgan uylar (batafsil)</span>
                        ...
                        <div className="chart-body">
                            <AmComposedChart
                                ...
                                lineField={{ field: 'percentage', name: 'Sotilish foizi', color: '#ef4444' }}
                                height={300}
                            />
                        </div>
                    </div>
        ...
        return (
            <div className="analytics-dashboard">
                <div className="charts-grid">
                    ...
                    {extraLeadsStats?.conversion_funnel && extraLeadsStats.conversion_funnel.some(d => d.count > 0) && (
                        <div className="chart-card">
                            <div className="chart-card-header">
                                <span className="chart-number">1. Lead konversiya varonkasi</span>
                                <h4>Umumiy konversiya holati</h4>
                            </div>
                            <div className="chart-body" style={{ display: 'flex', justifyContent: 'center', padding: '20px 0' }}>
                                <FunnelChart
                    ...
                    {stats.current_stage_counts && stats.current_stage_counts.filter(d => d.stage_name).length > 0 && (
                        <div className="chart-card">
                            <div className="chart-card-header">
                                <span className="chart-number">2. Lead bosqich xolati varonkasi</span>
                                ...
                                <FunnelChart
                                    items={(stats.current_stage_counts || [])
                                        ...
                                        .map((d, i) => ({
                                            name: d.stage_name,
                                            count: d.count,
                                            color: d.stage_color || ['#6366f1', '#10b981', '#f59e0b', '#ef4444', '#06b6d4', '#8b5cf6', '#ec4899', '#3b82f6'][i % 8],
                                        }))}
                                    height={350}
                                />
                            </div>
                    ...
                    {extraLeadsStats?.by_operator && extraLeadsStats.by_operator.length > 0 && (
                        <div className="chart-card wide">
                            <div className="chart-card-header">
                                <span className="chart-number">3. Operatorlar bo'yicha bosqichlar (Funnel)</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">4. Kunlik qo'shilgan Leadlar soni</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">5. Operatorlar bo'yicha Leadlar soni</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">6. Leadlar bosqichlar bo'yicha taqsimoti</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">7. Qo'ng'iroq holati bo'yicha Leadlar</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">8. Leaddagi o'rtacha qo'ng'iroq davomiyligi (kunlar bo'yicha)</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">9. Har bir operator bo'yicha qo'ng'iroq holati</span>
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">10. Bosqichlar bo'yicha joriy Leadlar soni</span>
                            <h4>Bosqichlar bo'yicha joriy Leadlar soni</h4>
                        </div>
                        <div className="chart-body">
                            <AmBarChart
                                data={(stats.current_stage_counts || []).filter(d => d.stage_name)}
                                xField="stage_name"
                                yField="count"
                                height={250}
                                horizontal={true}
                    ...
                    <div className="chart-card">
                        <div className="chart-card-header">
                            <span className="chart-number">11. Leadlar oylik tahlili (faoliyat trendi)</span>
                    ...
                    {/* This was originally chart 10, but it's a duplicate of chart 6 now. Removing it. */}
                    {/* {extraLeadsStats?.by_operator && extraLeadsStats.by_operator.length > 0 && (
                        <div className="chart-card wide">
                            <div className="chart-card-header">
                                <span className="chart-number">10. Operatorlar bo'yicha bosqichlar (Funnel)</span>
                                <h4>Operatorlar bo'yicha Leadlar bosqichi</h4>
                            </div>
                            <div className="chart-body" style={{ padding: '20px 0' }}>
                                <OperatorFunnel
