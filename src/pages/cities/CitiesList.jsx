...
const CitiesList = () => {
    ...
    const loadCities = async () => {
        try {
            ...
            const totalCount = Array.isArray(data) ? data.length : (data.count || citiesList.length || 0);
            setPagination(prev => ({
                ...prev,
                count: totalCount,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(modal.type === 'edit' ? 'Shaharni yangilashda xatolik' : 'Shahar yaratishda xatolik');
        } finally {
            setSaving(false);
        }
    };
                ...
                <div className="content-card">
                    ...
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <p>Hozircha shaharlar mavjud emas yoki qidiruv natijasi topilmadi</p>
                            <button className="btn-primary" onClick={openCreateModal}>
                                <PlusIcon />
                                    ...
                                    <tbody>
                                        {cities.map((city, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="cell-date">{formatDate(city.created)}</td>
                ...
                <div className={`modal-overlay ${modalClosing ? 'closing' : ''}`} onClick={closeModal}>
                    <div className={`modal-content modal-form ${modalClosing ? 'closing' : ''}`} onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <h3>{modal.type === 'edit' ? 'Shaharni tahrirlash' : 'Yangi shahar qo\'shish'}</h3>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="modal-form-body">
                                <div className="form-group">
                                    <label htmlFor="name" className="required">Shahar nomi</label>
                                    <input
                                        type="text"
                                        id="name"
                    ...
                    <div className={`modal-content ${modalClosing ? 'closing' : ''}`} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-body" style={{ textAlign: 'center', padding: '32px 24px' }}>
                            ...
                            <p style={{ fontSize: '16px', color: 'var(--text-primary)', marginBottom: '8px' }}>
                                <strong>{modal.city?.name}</strong> shahrini o'chirishni xohlaysizmi?
                            </p>
