...
const ContractEdit = () => {
    ...
    useEffect(() => {
        ...
        if (contractNumber === contract.contract_number) {
            setNumberValidation({ loading: false, available: true, suggestion: null, message: null });
            return;
        }
    ...
    }, [selectedHome, validationErrors, paymentData, clientData, numberValidation.available]);
